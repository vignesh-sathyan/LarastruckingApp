...
function ValidatePickUpArrivalDate() {
    ...
    if (pickupArrival != "" && new Date(pickupArrival) < new Date(yesterday)) {
...
function ValidatePickUpDepartureDate() {
    ...
    if (pickDeparture != "" && new Date(pickDeparture) < new Date(yesterday)) {
            ...
            success: function (response) {
                ...
                if (response != null) {
                    ...
                    for (var i = 0; i < response.ShipmentRoutesStop.length; i++) {
                        ...
                        objRouteStops.PickDateTime = response.ShipmentRoutesStop[i].PickDateTime == null ? "" : ConvertDate(response.ShipmentRoutesStop[i].PickDateTime, true);
                        objRouteStops.PickDateTimeTo = response.ShipmentRoutesStop[i].PickDateTimeTo == null ? "" : ConvertDate(response.ShipmentRoutesStop[i].PickDateTimeTo, true);

                        objRouteStops.DeliveryDateTime = response.ShipmentRoutesStop[i].DeliveryDateTime == null ? "" : ConvertDate(response.ShipmentRoutesStop[i].DeliveryDateTime, true);
                        objRouteStops.DeliveryDateTimeTo = response.ShipmentRoutesStop[i].DeliveryDateTimeTo == null ? "" : ConvertDate(response.ShipmentRoutesStop[i].DeliveryDateTimeTo, true);
