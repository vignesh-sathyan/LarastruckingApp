            ...
            success: function (response) {
                ...
                if (response != null) {
                    ...
                    for (var i = 0; i < response.GetFumigationRouteDetail.length; i++) {
                        ...
                        objRouteStop.DriverDeliveryArrival = response.GetFumigationRouteDetail[i].DriverDeliveryArrival == null ? "" : ConvertDate(response.GetFumigationRouteDetail[i].DriverDeliveryArrival, true);
                        objRouteStop.DriverDeliveryDeparture = response.GetFumigationRouteDetail[i].DriverDeliveryDeparture == null ? "" : ConvertDate(response.GetFumigationRouteDetail[i].DriverDeliveryDeparture, true);
                ...
                if (validateContact()) {
                    ...
                    if (glbRouteStops.length > 0) {
                        if (values.FumigationId > 0) {
                           // console.log("Picks: " , values.PickUpArrival);
                            $.ajax({
