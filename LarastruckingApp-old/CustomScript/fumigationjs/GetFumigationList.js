                ...
                "render": function (data, type, row, meta) {
                    ...
                    if (row.PickUpEquipment != null && row.PickUpEquipment != '') {
                        ...
                        if (isSame) {
                            ...
                            if (ftype.length > 1) {
                                for (var i = 0; i < ftype.length; i++) {
                                    tabCon += '<tr><td><label data-toggle="tooltip" data-placement="top">' + PickUpEquipment[i] + '</label></td></tr>';
                                }
                                return tabTop + tabCon + tabBottom;
                            }
                            else {
    ...
    $('#tblOtherFumigation').DataTable({
        ...
        "columns": [
                       ...
                       // console.log("pickupLocation: " + pickupLocation);
                        if (pickupLocation.length > 0) {
                            ...
                            if (isSame) {
                                ...
                                if (ftype.length > 1) {
                                    for (var i = 0; i < ftype.length; i++) {
                                        tabCon += '<tr><td><label data-toggle="tooltip" data-placement="top" title="' + GetCAddress(pickupLocation[0]) + '">' + GetCompany(pickupLocation[0]) + '</label></td></tr>';
                                    }
                                    return tabTop + tabCon + tabBottom;
                                }
                                else {
                                    return '<label data-toggle="tooltip" data-placement="top" title="' + GetCAddress(pickupLocation[0]) + '">' + GetCompany(pickupLocation[0]) + '</label>'
                                }
                               ...
                               // return '<label data-toggle="tooltip" data-placement="top" title="' + GetCAddress(pickupLocation[0]) + '">' + GetCompany(pickupLocation[0]) + '</label><br/>'
                                ...
                                if (pickupLocation.length > 0) {
                                    for (var i = 0; i < pickupLocation.length; i++) {
                                        ...
                                        lblPickupLocation += '<tr><td><label data-toggle="tooltip" data-placement="top" title="' + GetCAddress(pickupLocation[i]) + '">' + GetCompany(pickupLocation[i]) + '</label></td></tr>'
                                    }
                                   // lblPickupLocation = lblPickupLocation.trim("<br/>");
                                    return tabTop + lblPickupLocation + tabBottom;
                                }
            ...
            },
            {
                ...
                "render": function (data, type, row, meta) {
                    var isSame = false;
                    if (row.AWB_CP_CN != null && row.AWB_CP_CN != '') {
                        var awb = row.AWB_CP_CN.split('$');
                        if (awb.length > 0) {
                            var count = 0;
                    ...
                    if (row.VendorNConsignee != null && row.VendorNConsignee != '') {
                        ...
                        if (isSame) {
                            ...
                            if (ftype.length > 1) {
                                ...
                                return '<label data-toggle="tooltip" data-placement="top" title="' + vendorNconsignee[0] + '"></label>'
                            }
                ...
                "render": function (data, type, row, meta) {
                    ...
                    if (row.FumigationSite != null && row.FumigationSite != '') {
                        ...
                        if (isSame) {
                            ...
                            if (ftype.length > 1) {
                                for (var i = 0; i < ftype.length; i++) {
                                    tabCon += '<tr><td><label data-toggle="tooltip" data-placement="top" title="' + GetCAddress(fumigationSite[0]) + '">' + GetCompany(fumigationSite[0]) + '</label></td></tr>';
                                }
                                return tabTop + tabCon + tabBottom;
                            }
                            else {
                            ...
                            if (fumigationSite.length > 0) {
                                ...
                                var tabBottom = '</table>';
                                for (var i = 0; i < fumigationSite.length; i++) {
                                    lblfumigationSite += '<tr><td><label data-toggle="tooltip" data-placement="top" title="' + GetCAddress(fumigationSite[i]) + '">' + GetCompany(fumigationSite[i]) + '</label></td></tr>'
                                }
                               // lblfumigationSite = lblfumigationSite.trim("<br/>");
                                return tabTop + lblfumigationSite + tabBottom;
                            }
                    ...
                    if (row.DeliveryLocation != null && row.DeliveryLocation != '') {
                        ...
                        if (deliveryLocation.length > 0) {
                            ...
                            if (isSame) {
                                ...
                                if (ftype.length > 1) {
                                    for (var i = 0; i < ftype.length; i++) {
                                        tabCon += '<tr><td><label data-toggle="tooltip" data-placement="top" title="' + GetCAddress(deliveryLocation[0]) + '">' + GetCompany(deliveryLocation[0]) + '</label></td></tr>';
                                    }
                                    return tabTop + tabCon + tabBottom;
                                }
                                else {

                                    return '<label data-toggle="tooltip" data-placement="top" title="' + GetCAddress(deliveryLocation[0]) + '">' + GetCompany(deliveryLocation[0]) + '</label>'
                                }
                               // return '<label data-toggle="tooltip" data-placement="top" title="' + GetCAddress(deliveryLocation[0]) + '">' + GetCompany(deliveryLocation[0]) + '</label><br/>'
                                ...
                                if (deliveryLocation.length > 0) {
                                    ...
                                    var tabBottom = '</table>';
                                    for (var i = 0; i < deliveryLocation.length; i++) {
                                        lbldeliveryLocation += '<tr><td><label data-toggle="tooltip" data-placement="top" title="' + GetCAddress(deliveryLocation[i]) + '">' + GetCompany(deliveryLocation[i]) + '</label></td></tr>'
                                    }
                                    //lbldeliveryLocation = lbldeliveryLocation.trim("<br/>");
                                    return tabTop + lbldeliveryLocation + tabBottom;
                                }
