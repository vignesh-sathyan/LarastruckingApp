; (function ($, window, document, undefined) {
    ...
    $.qrCodeReader = {
        jsQRpath: baseUrl + "/Assets/QRcode/js/jsQR/jsQR.js",
        beepPath: baseUrl + "/Assets/QRcode/audio/beep.mp3",
        instance: null,
        defaults: {
    ...
    QRCodeReader.prototype = {
        ...
        doneReading: function () {
            ...
            // close the widget
            //  qrr.okBtn.off("click").on("click", qrr.close);
            //qrr.close();
        },
