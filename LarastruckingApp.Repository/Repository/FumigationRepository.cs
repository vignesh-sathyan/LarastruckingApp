...
namespace LarastruckingApp.Repository.Repository
{
    public class FumigationRepository : IFumigationRepository
    {
                ...
                List<SqlParameter> sqlParameters = new List<SqlParameter>
                    {
                        ...
                        new SqlParameter("@SortedColumns", entity.SortedColumns),
        ...
        public bool FumigationWTReady(int fumigationId, bool ready)
        {
                ...
                List<SqlParameter> sqlParameters = new List<SqlParameter>
                    {
                        ...
                        new SqlParameter("@WTReady",ready),
                     };
                var result = sp_dbContext.ExecuteStoredProcedure<int>("usp_UpdateFumigationWTReady", sqlParameters);
                return true;
            }
            catch (Exception)
            {
        ...
        public bool FumigationSTReady(int fumigationId, bool ready)
        {
                ...
                List<SqlParameter> sqlParameters = new List<SqlParameter>
                    {
                        ...
                        new SqlParameter("@FumigationId",fumigationId),
                        new SqlParameter("@STReady",ready),
                     };
                var result = sp_dbContext.ExecuteStoredProcedure<int>("usp_UpdateFumigationSTReady", sqlParameters);
                return true;
            }
            catch (Exception)
            {
        ...
        public bool DeleteComments(FumigationDTO entity)
        {
            ...
            {
                bool result = false;
                var table = fumigationContext.tblFumigationComments.Where(e => e.FumigationId == entity.FumigationId).ToList();
                if (table != null)
                {
                    //table.IsDeleted = true;
                    //table.DeletedBy = entity.CreatedBy;
                    //table.DeletedOn = entity.CreatedDate;
                    fumigationContext.tblFumigationComments.RemoveRange(table);
