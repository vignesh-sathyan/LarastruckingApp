    ...
    public class ShipmentRepository : IShipmentRepository
    {
        ...
        public async Task<List<AllShipmentList>> ViewShipmentList(AllShipmentDTO entity)
        {
            ...
            try
            {
                ...
                {
                    result = await Task.FromResult(sp_dbContext.ExecuteStoredProcedure<AllShipmentList>("usp_GetShipment_NotOrderTaken_List", sqlParameter));
                }
        ...
        public bool ShipmentWTReady(int shipmentId, bool ready)
        {
            ...
            try
            {
                ...
                var result = sp_dbContext.ExecuteStoredProcedure<int>("usp_UpdateShipmenetWTReady", sqlParameters);
                return true;
            }
            catch (Exception)
            {
        ...
        public bool ShipmentSTReady(int shipmentId, bool ready)
        {
            ...
            try
            {
                ...
                var result = sp_dbContext.ExecuteStoredProcedure<int>("usp_UpdateShipmenetSTReady", sqlParameters);
                return true;
            }
            catch (Exception)
            {
     ...
     // Get Customer Name by Dart
        ...
        public bool DeleteComments(ShipmentDTO entity)
        {
            ...
            {
                bool result = false;
                var table = shipmentContext.tblShipmentCommments.FirstOrDefault(e => e.ShipmentId == entity.ShipmentId);
                if (table != null)
                {
                    //table.IsDeleted = true;
                    //table.DeletedBy = entity.CreatedBy;
                    //table.DeletedOn = entity.CreatedDate;
                    shipmentContext.tblShipmentCommments.Remove(table);
                    //shipmentContext.Entry(table).State = System.Data.Entity.EntityState.Modified;
                    result = shipmentContext.SaveChanges() > 0;
                }
                return result;
