...
namespace LarastruckingApp.Repository.EF
{
    ...
    public partial class LarastruckingDBEntities : DbContext
    {
        ...
        public virtual ObjectResult<usp_GetFumigationList_Result> usp_GetFumigationList(string searchTerm, string sortColumn, string sortOrder, Nullable<int> pageNumber, Nullable<int> pageSize)
        {
            var searchTermParameter = searchTerm != null ?
                new ObjectParameter("SearchTerm", searchTerm) :
                new ObjectParameter("SearchTerm", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_GetFumigationList_Result>("usp_GetFumigationList", searchTermParameter, sortColumnParameter, sortOrderParameter, pageNumberParameter, pageSizeParameter);
        }
        ...
        public virtual ObjectResult<usp_GetShipment_NotOrderTaken_List_Result> usp_GetShipment_NotOrderTaken_List(string searchTerm, string sortColumn, string sortOrder, Nullable<int> pageNumber, Nullable<int> pageSize)
        {
            var searchTermParameter = searchTerm != null ?
                new ObjectParameter("SearchTerm", searchTerm) :
                new ObjectParameter("SearchTerm", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_GetShipment_NotOrderTaken_List_Result>("usp_GetShipment_NotOrderTaken_List", searchTermParameter, sortColumnParameter, sortOrderParameter, pageNumberParameter, pageSizeParameter);
        }
    
        public virtual ObjectResult<usp_GetShipment_OrderTaken_List_Result> usp_GetShipment_OrderTaken_List(string searchTerm, string sortColumn, string sortOrder, Nullable<int> pageNumber, Nullable<int> pageSize)
        {
            var searchTermParameter = searchTerm != null ?
                new ObjectParameter("SearchTerm", searchTerm) :
                new ObjectParameter("SearchTerm", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_GetShipment_OrderTaken_List_Result>("usp_GetShipment_OrderTaken_List", searchTermParameter, sortColumnParameter, sortOrderParameter, pageNumberParameter, pageSizeParameter);
        }
        ...
        public virtual ObjectResult<usp_GetCompletedNcancelFumList_Result> usp_GetCompletedNcancelFumList(string searchTerm, string sortColumn, string sortOrder, Nullable<int> pageNumber, Nullable<int> pageSize, Nullable<System.DateTime> startDate, Nullable<System.DateTime> endDate, Nullable<int> customerId, Nullable<int> statusId, string driverName)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_GetCompletedNcancelFumList_Result>("usp_GetCompletedNcancelFumList", searchTermParameter, sortColumnParameter, sortOrderParameter, pageNumberParameter, pageSizeParameter, startDateParameter, endDateParameter, customerIdParameter, statusIdParameter, driverNameParameter);
        }
        ...
        public virtual ObjectResult<usp_GetOrderTakenFumigationList_Result> usp_GetOrderTakenFumigationList(string searchTerm, string sortColumn, string sortOrder, Nullable<int> pageNumber, Nullable<int> pageSize)
        {
            var searchTermParameter = searchTerm != null ?
                new ObjectParameter("SearchTerm", searchTerm) :
                new ObjectParameter("SearchTerm", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_GetOrderTakenFumigationList_Result>("usp_GetOrderTakenFumigationList", searchTermParameter, sortColumnParameter, sortOrderParameter, pageNumberParameter, pageSizeParameter);
        }
