    ...
    $.ajax({
       ...
       // console.log("VehicleList: ", vehicleList);
        ...
        for (let i = 0; i < vehicleList.Data.length; i++) {
            ...
            //console.log("vehicleId: " , vehicleDetails);
...
GetGpsTrakingMapDetails = function (shipmentLatLong) {
    ...
    var vehicleDetails = [];
    var vehicleLive;
    /* Dart Code for getting Vehicle Details */
    ...
    $.when(
        ...
        console.log("VehicleListLives: ", vehicleLive);
        // console.log("VehicleList: ", vehicleList);
        //console.log("VehicleList: ", vehicleList.Data.length);
        for (let i = 0; i < vehicleList.Data.length; i++) {
           // console.log("VehicleList: ", vehicleList.Data[i].VehicleIcon);
            ...
            //console.log("vehicleId: " , vehicleDetails);
            // vehicleDetail[i] = vehicleDetails[i];
    ...
    let extractedValue = vehicleDetails.map(item => item['VehicleId']);
    //const result = extractValue(vehicleDetails, 'VehicleId');
    //let result = vehicleDetails.map(a => a.VehicleId);
    console.log("makers array: ", vehicleDetails);

 
    //console.log("makers array: ", result);
    console.log("makers vehicleId: " + extractedValue);
   
    for (let i = 0; i < vehicleDetails.length; i++) {
        console.log("makers: ", vehicleDetails[i].VehicleIcon);
        var name = vehicleDetails.VehicleIcon;
    ...
    if (shipmentLatLong != undefined && shipmentLatLong.length > 0) {
        ...
        for (i = 0; i < markers.length; i++) {
            ...
            var marker = new google.maps.Marker({
                ...
                map: map,
                title: data.Event,
                icon: "https://qws.quartix.com/v2/content/images/lorry-black.png"
            });
        ...
        lat_lng.push(myLatlng);
        let icons = {
            url: 'https://qws.quartix.com/v2/content/images/lorry-black.png',
