        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data != null) {
                    ...
                    console.log("GpsDataLIVE: ", vehicleLive);
                }
            },
            error: function () {
                console.log("URL123: " + baseUrl + "CustomScript/GpsTracker.aspx");
                console.log("Vehicle Live List ERROR");
            }
        }),
        $.ajax({
            url: baseUrl + "CustomScript/GpsTracker.aspx",
            success: function (data) {
                ...
                if (data != null) {
                    ...
                    console.log("GpsData: ", vehicleList);
                }
            },
            error: function () {
...
bindDrivertable = function (_data) {
    ...
    for (var i = 0; i < _data.ShipmentEquipmentNdriver.length; i++) {
        dtDriverBody += "<tr>" +
            "<td> <input type='radio' name='radioDriverId' id='radioDriverId' onchange='GetRadionButton(this)' value='" + _data.ShipmentEquipmentNdriver[i].UserId + "' /> </td>" +
            "<td><label name='lblDriverName'>" + _data.ShipmentEquipmentNdriver[i].DriverName + "</label> </td>" +
            "<td><label id='lblEquipmentName' name='lblEquipmentName'>" + _data.ShipmentEquipmentNdriver[i].EquipmentName + "</label> </td>" +
            "</tr>";
    }
...
GetGpsTrakingMapDetails = function (shipmentLatLong) {
    ...
    console.log("currVehicleID11: ", vehicleDetails.length);
