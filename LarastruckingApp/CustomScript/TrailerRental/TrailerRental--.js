                ...
                if (response != null) {
                    ...
                    if (response.TrailerRentalDetail != null) {
                        for (var i = 0; i < response.TrailerRentalDetail.length; i++) {
                            ...
                            objTrailerRentalDetail.StartDate = ConvertDate(response.TrailerRentalDetail[i].StartDate, true);
                            objTrailerRentalDetail.EndDate = ConvertDate(response.TrailerRentalDetail[i].EndDate, true);
                            objTrailerRentalDetail.ReturnedDate = response.TrailerRentalDetail[i].ReturnedDate == null ? "" : ConvertDate(response.TrailerRentalDetail[i].ReturnedDate, true);
...
//#endregionfunction BindPickUpAndDeliveryDriver() {    var value = {};
