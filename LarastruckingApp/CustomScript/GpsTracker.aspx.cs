...
public partial class GpsTracker : System.Web.UI.Page
{
    ...
    public  string RunPostAsync()
    {
        ...
        var Password = ConfigurationManager.AppSettings["QPassword"];
    ...
    public string GetVehicleListLive()
    {
        ...
        Cookie requiredCookie = new Cookie("AccessToken", GpsAccessToken.Text);
        ...
        request.Headers.Add("AccessToken", GpsAccessToken.Text);
