...
function SendMessage() {
   ...
   // console.log("AWB: "+AWB);
    ...
    $.when(
        ...
        //if (PickupLocation != prevalues.pickupLocation || DeliveryLocation != prevalues.DeliveryLocation || Equipment != prevalues.EquipmentName || pallets != prevalues.Pallets || boxes != prevalues.Boxes || AWB != prevalues.AirWayBill) {
            if (driverphone != "" || driverphone != "undefined") {
                ...
                $.ajax({
                    ...
                    data: "{ 'picLoc': '" + finalSMSBodyStr + "','phone': '" + driverphone + "'}",
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'text',
                    success: function (msg) {
                        // Do something interesting here.
                    ...
                    $.ajax({
                        ...
                        beforeSend: function () {
                           ...
                           // const  = values.ShipmentEquipmentNdriver[0];
                            if (ShipmentEquipmentNdriver!=false) {
                                SendMessage();
                            }
                            else {
