                ...
                if (values.ShipmentId > 0) {
                    ...
                    $.ajax({
                        ...
                        beforeSend: function () {
                            ...
                            if (ShipmentEquipmentNdriver != false && prevalues.EquipmentName != "null" && ddlstatus == "DISPATCHED") {
                                if (PickupLocation != prevalues.pickupLocation || DeliveryLocation != prevalues.DeliveryLocation || pallets != prevalues.Pallets || boxes != prevalues.Boxes || AWB != prevalues.AirWayBill) {
                                    SendMessage();
                                }
                            }
