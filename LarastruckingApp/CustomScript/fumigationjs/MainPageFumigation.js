        ...
        buttons: [
            {
                ...
                customize: function (win) {
                    ...
                    $(win.document.body)
                        .css('font-size', '10pt')
                        .prepend(
                            "<table id='checkheader'><tr><td width='80%' ><h3 style='font-size: 20px;'>REQUESTED FUMIGATION</h3></td><td width='20%'><div><img src='"+baseUrl+"/Images/Laraslogo.png' height='100px'/></div></td></tr></table>"
                        );
                }
            },
            {
        ...
        buttons: [
            {
                ...
                customize: function (win) {
                    ...
                    $(win.document.body)
                        .css('font-size', '10pt')
                        .prepend(
                            "<table id='checkheader'><tr><td width='80%' ><h3 style='font-size: 20px;'>FUMIGATION IN PROGRESS</h3> </td><td width='20%'><div><img src='"+baseUrl+"/Images/Laraslogo.png' height='100px'/></div></td></tr></table>"
                        );
                }
            },
            ,
                    ...
                    if (row.FumigationTypes != null && row.FumigationTypes != '') {
                        ...
                        if (fumigationTypesList.length > 0) {
                            ...
                            if (isSame) {
                                ...
                                if (ftype.length > 1) {
                                    for (var i = 0; i < ftype.length; i++) {
                                        tabCon += '<tr style="background: none;"><td><label data-toggle="tooltip" data-placement="top" title="' + GetCAddressNew(fumigationTypesList[0]) + '">' + GetCompanyNew(fumigationTypesList[0]) + '</label></td></tr>';
                                    }
                                    return tabTop + tabCon + tabBottom;
                                }
                                else {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            if (data != null) {
								...
								console.log("data fumigation copy: ",data);
