                            ...
                            if (isSame) {
                                ...
                                if (ftype.length > 1) {
                                    for (var i = 0; i < ftype.length; i++) {
                                        ...
                                        tabCon += '<tr><td><label data-toggle="tooltip" data-placement="top">' + ConvertDateNew(PickUpArrival[0], true) + '</label></td></tr>';
                                    ...
                                    return '<label data-toggle="tooltip" data-placement="top">' + ConvertDateNew(PickUpArrival[0], true) + '</label>';
                                ...
                                if (PickUpArrival.length > 0) {
                                    for (var i = 0; i < PickUpArrival.length; i++) {
                                        tabCon += '<tr><td><label data-toggle="tooltip" data-placement="top">' + ConvertDateNew(PickUpArrival[i], true) + '</label></td></tr>';
            ...
            },
            {
                ...
                "render": function (data, type, row, meta) {
                    ...
                    if (row.ActFumigationRelease != null && row.ActFumigationRelease != " ") {
                        ...
                        if (ConvertDateNew(ActFumigationRelease[0], true) != "NaN/NaN NaN:NaN") {
                            ...
                            if (ActFumigationRelease.length > 0) {
                                ...
                                if (isSame) {
                                    ...
                                    if (ftype.length > 1) {
                                        for (var i = 0; i < ftype.length; i++) {
                                            if (ConvertDateNew(ActFumigationRelease[0], true) != "NaN/NaN NaN:NaN") {
                                                tabCon += '<tr><td><label data-toggle="tooltip" data-placement="top" title="">' + ConvertDateNew(ActFumigationRelease[0], true) + '</label></td></tr>';
                                            }
                                            else {
                                        ...
                                        if (ConvertDateNew(ActFumigationRelease[0], true) != "NaN/NaN NaN:NaN") {
                                            return '<label data-toggle="tooltip" data-placement="top" title="">' + ConvertDateNew(ActFumigationRelease[0], true) + '</label>'
                                        }
                                        else {
                                    ...
                                    for (let i = 0; i < ActFumigationRelease.length; i++) {
                                        if (ConvertDateNew(ActFumigationRelease[i], true) != "NaN/NaN NaN:NaN") {
                                            tabCon += '<tr><td><label data-toggle="tooltip" data-placement="top">' + ConvertDateNew(ActFumigationRelease[i], true) + '</label></td></tr>';
                                        }
                                        else {
                        ...
                        if (pickupLocation.length > 0) {
                            ...
                            if (isSame) {
                                ...
                                if (ftype.length > 1) {
                                    ...
                                    return '<label data-toggle="tooltip" data-placement="top" title="' + GetCAddressNew(pickupLocation[0]) + '">' + GetCompanyNew(pickupLocation[0]) + '</label>'
                                }
                   ...
                   // console.log("tblother: ",row);
                    if (row.VendorNConsignee != null && row.VendorNConsignee != '') {
                        ...
                        if (isSame) {
                            ...
                            if (ftype.length > 1) {
                                for (var i = 0; i < ftype.length; i++) {
                                    tabCon += '<tr><td><label data-toggle="tooltip" data-placement="top" title="' + vendorNconsignee[0] + '">' + vendorNconsignee[0] + '</label></td></tr>';
                                }
                                return tabTop + tabCon + tabBottom;
                            }
                            else {
                              ...
                              //  console.log("Isame true: " + isSame);
                                return '<label data-toggle="tooltip" data-placement="top" title="' + row.VendorNConsignee + '">'+row.VendorNConsignee+'</label>'
                            }
                           // return '<label data-toggle="tooltip" data-placement="top">' + vendorNconsignee[0] + '</label>'
                            ...
                            var tabBottom = '</table>';
                            for (var i = 0; i < vendorNconsignee.length; i++) {
                                tabCon += '<tr><td><label data-toggle="tooltip" data-placement="top">' + vendorNconsignee[i] + '</label></td></tr>'
                            }
                            return tabTop + tabCon + tabBottom
                            }
                    ...
                    if (row.FumigationSite != null && row.FumigationSite != '') {
                        ...
                        if (isSame) {
                            ...
                            if (ftype.length > 1) {
                                ...
                                return '<label data-toggle="tooltip" data-placement="top" title="' + GetCAddressNew(fumigationSite[0]) + '">' + GetCompanyNew(fumigationSite[0]) + '</label><br/>'
                            }
            ...
            },
            {
                ...
                "render": function (data, type, row, meta) {
                    ...
                    if (row.ActLoadingStart != null && row.ActLoadingStart != " ") {
                        ...
                        if (ConvertDateNew(ActLoadingStart[0], true) != "NaN/NaN NaN:NaN") {
                        if (ActLoadingStart.length > 0) {
                            ...
                            if (isSame) {
                                ...
                                if (ftype.length > 1) {
                                    for (var i = 0; i < ftype.length; i++) {
                                        if (ConvertDateNew(ActLoadingStart[0], true) != "NaN/NaN NaN:NaN") {
                                            tabCon += '<tr><td><label data-toggle="tooltip" data-placement="top" title="">' + ConvertDateNew(ActLoadingStart[0], true) + '</label></td></tr>';
                                        }
                                        else {
                                            tabCon += '<tr><td><label data-toggle="tooltip" data-placement="top" title="">NA</label></td></tr>';
                                        }
                                    ...
                                    if (ConvertDateNew(ActLoadingStart[0], true) != "NaN/NaN NaN:NaN") {
                                        return '<label data-toggle="tooltip" data-placement="top" title="">' + ConvertDateNew(ActLoadingStart[0], true) + '</label>';
                                    }
                                    else {
                                        return '<label data-toggle="tooltip" data-placement="top" title="">NA</label>';
                                    }
                                ...
                                for (let i = 0; i < ActLoadingStart.length; i++) {
                                    if (ConvertDateNew(ActLoadingStart[i], true) != "NaN/NaN NaN:NaN") {
                                        tabCon += '<tr><td><label data-toggle="tooltip" data-placement="top">' + ConvertDateNew(ActLoadingStart[i], true) + '</label></td></tr>';
                                    }
                                    else {
                                        tabCon += '<tr><td><label data-toggle="tooltip" data-placement="top">NA</label></td></tr>';
                                    }
                ...
                "render": function (data, type, row, meta) {
                   // console.log("ActLoadingFinish ", ConvertDateNew(ActLoadingFinish[0], true))
                    ...
                    if (row.ActLoadingFinish != null && row.ActLoadingFinish != " ") {
                        ...
                        if (ConvertDateNew(ActLoadingFinish[0], true) != "NaN/NaN NaN:NaN") {
                        if (ActLoadingFinish.length > 0) {
                            ...
                            if (isSame) {
                                ...
                                if (ftype.length > 1) {
                                    for (var i = 0; i < ftype.length; i++) {
                                        if (ConvertDateNew(ActLoadingFinish[0], true) != "NaN/NaN NaN:NaN") {
                                            tabCon += '<tr><td><label data-toggle="tooltip" data-placement="top" title="">' + ConvertDateNew(ActLoadingFinish[0], true) + '</label></td></tr>';
                                        }
                                        else {
                                            tabCon += '<tr><td><label data-toggle="tooltip" data-placement="top" title="">NA</label></td></tr>';
                                        }
                                    ...
                                    if (ConvertDateNew(ActLoadingFinish[0], true) != "NaN/NaN NaN:NaN") {
                                        return '<label data-toggle="tooltip" data-placement="top" title="">' + ConvertDateNew(ActLoadingFinish[0], true) + '</label>';
                                    }
                                    else {
                                        return '<label data-toggle="tooltip" data-placement="top" title="">NA</label>';
                                    }
                                ...
                                for (let i = 0; i < ActLoadingFinish.length; i++) {
                                    if (ConvertDateNew(ActLoadingFinish[i], true) != "NaN/NaN NaN:NaN") {
                                        tabCon += '<tr><td><label data-toggle="tooltip" data-placement="top">' + ConvertDateNew(ActLoadingFinish[i], true) + '</label></td></tr>';
                                    }
                                    else {
                                        tabCon += '<tr><td><label data-toggle="tooltip" data-placement="top">NA</label></td></tr>';
                                    }
                    ...
                    if (row.DeliveryLocation != null && row.DeliveryLocation != '') {
                        ...
                        if (deliveryLocation.length > 0) {
                            ...
                            if (isSame) {
                                ...
                                if (ftype.length > 1) {
                                    for (var i = 0; i < ftype.length; i++) {
                                        tabCon += '<tr><td><label data-toggle="tooltip" data-placement="top" title="' + GetCAddressNew(deliveryLocation[0]) + '">' + GetCompanyNew(deliveryLocation[0]) + '</label></td></tr>';
                                    }
                                    return tabTop + tabCon + tabBottom;
                                }
                                else {

                                    return '<label data-toggle="tooltip" data-placement="top" title="' + GetCAddressNew(deliveryLocation[0]) + '">' + GetCompanyNew(deliveryLocation[0]) + '</label>'
                                }
...
$("#btnCancel").click(function () {
    window.location.href = baseUrl + "/Fumigation/Fumigation/ViewFumigationList";
   // $("#fumigationModal").css('display', 'none');
   // $("#fumigationModal").removeAttr("aria-modal");
   // $('#fumigationModal').attr("aria-hidden", "true");
    //$("#fumigationModal").removeClass("show");
