            ...
            for (let i = 0; i < response.GetFumigationRouteDetail.length; i++) {
                ...
                if (response.FumigationEquipmentNDriver.length > 0) {
                    for (let j = 0; j < response.FumigationEquipmentNDriver.length; j++) {
                        ...
                        console.log("deliveryDriver: " + response.FumigationEquipmentNDriver[j].IsPickUp + " : " + response.FumigationEquipmentNDriver[j].DriverName + " : " + deliveryDriver + " : " + DriverID);
                    }
                }
            ...
            success: function (response) {
                ...
                if (response != null) {
                    ...
                    for (let i = 0; i < response.FumigationEquipmentNDriver.length; i++) {
                        ...
                        //console.log("EquipmentId: ", response.FumigationEquipmentNDriver[i]);
...
function AddRouteStops() {
    ...
    if ($("#tblShipmentDetail").attr("data-row-no") > 0) {
        ...
        //console.log("edit equipment : ", routedetail.PickUpEquipment);
        ...
        console.log("add equipment : ", objRouteStop.PickUpEquipment);
...
function SendMessage() {
    ...
    for (var i = 0; i < fumSMSArr.length; i++) {
        ...
        if (i > 0) {
            ...
            if (samePickUp) {
                var PickArrival = ConvertWithoutUTC(fumSMSArr[i].PickUpArrival, true);
    ...
    for (var j = 0; j < fumSMSArr.length; j++) {
        ...
        if (!samePickUp) {
            var PickArrival = ConvertWithoutUTC(fumSMSArr[j].PickUpArrival, true);
...
function SendEditMessage() {
    ...
    for (var i = 0; i < fumSMSArr.length; i++) {
        console.log("Equipment: " + fumSMSArr[i].Equipment + " pre: " + prevalues[i].EquipmentName + " PickupLocation: " + fumSMSArr[i].PickupLocation + " pre: " + prevalues[i].PickUpLocation + " boxes: " + fumSMSArr[i].boxes + " pre: " + prevalues[i].Boxes + " pallets: " + fumSMSArr[i].pallets + " pre: " + prevalues[i].Pallets + " TrailerPosition: " + fumSMSArr[i].TrailerPosition + " pre: " + prevalues[i].TrailerPosition + " FumigationLocation: " + fumSMSArr[i].FumigationLocation + " pre: " + prevalues[i].FumigationLocation + " AWB: " + fumSMSArr[i].AWB + " pre: " + prevalues[i].AirWayBill);
        if (fumSMSArr[i].Equipment != "") {
            if (fumSMSArr[i].Equipment != prevalues[i].EquipmentName || fumSMSArr[i].PickupLocation != prevalues[i].PickUpLocation || fumSMSArr[i].boxes != prevalues[i].Boxes || fumSMSArr[i].pallets != prevalues[i].Pallets || fumSMSArr[i].TrailerPosition != prevalues[i].TrailerPosition || fumSMSArr[i].FumigationLocation != prevalues[i].FumigationLocation || fumSMSArr[i].AWB != prevalues[i].AirWayBill) {
                fumedit = true;
            }
            if (fumSMSArr[i].DriverID != prevalues[i].DriverID) {
                fumedit = true;
            }
        }
...
function SendDeliveryMessage() {
    ...
    for (var i = 0; i < fumSMSArr.length; i++) {
        ...
        if (fumSMSArr[i].Equipment != "") {
            if (fumSMSArr[i].DeliveryLocation != prevalues[i].DeliveryLocation || fumSMSArr[i].boxes != prevalues[i].Boxes || fumSMSArr[i].pallets != prevalues[i].Pallets || fumSMSArr[i].TrailerPosition != prevalues[i].TrailerPosition || fumSMSArr[i].FumigationLocation != prevalues[i].FumigationLocation || fumSMSArr[i].AWB != prevalues[i].AirWayBill) {
                fumedit = true;
            }
                    ...
                    if (glbRouteStops.length > 0) {
                        if (values.FumigationId > 0) {
                            ...
                            $.ajax({
                                ...
                                beforeSend: function () {
                                    showLoader();
                                    console.log("pickup: ", values.FumigationEquipmentNdriver);
                                    var deliveryDriver = "";
                    ...
                    if (tempupload.length) {
                        ...
                        if (routeStops[0].FumigationRoutsId > 0) {
                            ...
                            if (radioValue > 0) {
                                ...
                                data.append("FumigationRouteId", routeStops[0].FumigationRoutsId);
