            ...
            try
            {
                ...
                using (MemoryStream stream = new System.IO.MemoryStream())
                {
                   ...
                   pdfDoc.Close();
                    ...
                    string endDate = bodyText5[1];
                    string bodywithsignature = LarastruckingResource.QuoteMailSignature;
                    string fileName = model.User+"_"+ bodyText3 + ".pdf";
                    ...
                    ErrorLog("Mail Response TimeCard : " + mailSentResponse);
                    return mailSentResponse;
                }
            }
            catch (Exception ex)
            {
                ErrorLog("TimeCard Mail error : " + ex.Message);
                throw;
            }
            finally
            {
