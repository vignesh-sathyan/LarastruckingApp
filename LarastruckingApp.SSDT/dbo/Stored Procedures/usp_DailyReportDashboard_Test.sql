...
--exec [usp_DailyReportDashboard_Test] 2,'','StatusName','asc',0,10, @TotalCount out                          
--print @TotalCount            
                    
                      
CREATE PROCEDURE [dbo].[usp_DailyReportDashboard_Test]                      
(@UserId  INT,    
 @StatusId INT,
 @CustomerId INT,                                                                          
    ...
    BEGIN                      
     ...
     CTEDR.DriverName,                       
                 ...
                 -- INNER JOIN cte_getPickDate CTEP ON TS.ShipmentId = CTEP.ShippingId                      
                  ...
                  WHERE TU.UserId =@UserId  AND TS.IsDeleted = 0 AND TS.StatusId=@StatusId AND TCR.CustomerID =@CustomerId    
                                        
                   AND( (ISNULL(@SearchTerm, '') = ''                      
                       OR CTES.StatusName LIKE '%' + @SearchTerm + '%')                      
