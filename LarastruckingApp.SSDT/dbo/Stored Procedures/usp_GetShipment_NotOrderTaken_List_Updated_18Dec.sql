CREATE PROC [dbo].[usp_GetShipment_NotOrderTaken_List_Updated_18Dec]                  
...
select  [TotalCount]= COUNT(TotalCountRow) over(), ShipmentId,AirWayBill,CustomerPO,StatusId, StatusName,CustomerID,CustomerName,Driver,Equipment,PickupDate,DeliveryDate,PickupLocation,DeliveryLocation,Quantity           
       from view_GetOrderNotTakenShipment_Updated_18Dec where          
    ...
    (                  
      ...
      group by TotalCountRow,   ShipmentId,AirWayBill,CustomerPO,StatusId, StatusName,CustomerID,CustomerName,Driver,Equipment,PickupDate,DeliveryDate,PickupLocation,DeliveryLocation,Quantity             
ORDER BY CASE                  
