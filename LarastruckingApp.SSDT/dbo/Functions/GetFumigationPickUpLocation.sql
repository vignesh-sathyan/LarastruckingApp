...
--drop FUNCTION  [GetFumigationPickUpLocation]
CREATE FUNCTION [dbo].[GetFumigationPickUpLocation]
(
...
--          CONCAT(PA.CompanyName,', ',PA.Address1,' ',PA.City,' ',PST.Name,' ',PA.Zip ) as FumigationPickUpLocation
----		  STUFF(
----(
...
--         LEFT JOIN tblAddress PA ON FURT1.PickUpLocation = PA.AddressId
--         LEFT JOIN tblState PST ON PA.State = PST.ID
--    WHERE FURT1.FumigationId =3-- @FumigationRoutsId
