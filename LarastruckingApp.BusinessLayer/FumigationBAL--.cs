    ...
    public class FumigationBAL : IFumigationBAL
    {
        ...
        public FumigationDTO CreateFumigation(FumigationDTO entity)
        {
            foreach (var route in entity.FumigationRouteDetail)
            {
                ...
                route.PickUpArrival = route.PickUpArrival == null ? route.PickUpArrival : Configurations.ConvertLocalToUTC(Convert.ToDateTime(route.PickUpArrival));
                //route.PickUpArrival =  (route.PickUpArrival == null ? route.PickUpArrival : route.PickUpArrival);
              // route.PickUpArrival = new DateTime(2015, 12, 31, 5, 10, 20);
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public IList<FumigationArchiveListDTO> ViewAllFumigation(AllShipmentDTO entity)
        {
