...
{
    public interface IDriverModuleBAL
    {
        ...
        /// <returns></returns>
        ShipmentLocationDetailsDto GetShipmentLocationDetails(int ShippingRoutesId);
        #endregion
        ...
        #region Get Shipment Routes Stop Detail
        /// <summary>
        /// Get Shipment Routes Stop Detail
        /// </summary>
        /// <param name="ShippingRoutesId"></param>
        /// <returns></returns>
        ...
        /// <returns></returns>
        bool SelectignaturePadDetail(int shipmentRouteId);
        #endregion
