...
namespace LarastruckingApp.DAL
{
    public class FumigationDAL : IFumigationDAL
    {
        ...
        public bool FumigationWTReady(int fumigaitonId, bool ready)
        {
            return iFumigationRepository.FumigationWTReady(fumigaitonId, ready);
        }

        public bool FumigationSTReady(int fumigaitonId, bool ready)
        {
            return iFumigationRepository.FumigationSTReady(fumigaitonId, ready);
        }
