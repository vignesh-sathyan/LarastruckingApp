...
namespace LarastruckingApp.DAL
{
    public class ShipmentDAL : IShipmentDAL
    {
        ...
        {
            return shipmentRepository.ShipmentWTReady(shipmentId, ready);
        }

        public bool ShipmentSTReady(int shipmentId, bool ready)
        {
            return shipmentRepository.ShipmentSTReady(shipmentId, ready);
        }
        ...
        {
            return shipmentRepository.DeleteComments(entity);
